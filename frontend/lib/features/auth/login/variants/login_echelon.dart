...
import 'register_echelon.dart';

class LoginEchelon extends StatefulWidget {
  const LoginEchelon({super.key});

  @override
  State<LoginEchelon> createState() => _LoginEchelonState();
}

class _LoginEchelonState extends State<LoginEchelon> with SingleTickerProviderStateMixin {
                  ...
                  child: Column(
                    children: [
                                  ...
                                  child: Column(
                                    children: [
                                      ...
                                      Align(
                                        ...
                                        child: TextButton(
                                          onPressed: () {},
                                          child: Text("Forgot password?", style: GoogleFonts.inter(color: const Color(0xFF00F5FF))),
                                        ),
                                      ),
                      ...
                      Row(
                        ...
                        children: [
                          Text("New to Echelon? ", style: GoogleFonts.inter(color: Colors.white60)),
                          TextButton(
                            onPressed: () => Navigator.push(context, MaterialPageRoute(builder: (_) => const RegisterEchelon())),
                            child: Text("Create account", style: GoogleFonts.inter(color: const Color(0xFF00F5FF), fontWeight: FontWeight.w600)),
                          ),
                        ],
                      ),
                    ],
